...
/**
 * Created by juanjose1 on 11/19/16.
 */
@Autonomous(name = "blue delayed" , group = "Autonomous")
public class autoblue extends LinearOpMode {
    ...
    static final double COUNTS_PER_MOTOR_REV2 = 1680;
    ...
    public void runOpMode() throws InterruptedException {
       ...
       /* shooterleft = hardwareMap.dcMotor.get("shooterleft");
        ...
        encoderDrive(TURN_SPEED, 0, 0, 5.0);
        sleep(8000);
